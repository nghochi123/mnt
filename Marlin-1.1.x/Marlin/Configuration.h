...
#define DELTA_PRINTABLE_RADIUS 135.0 // mm

// Center-to-center distance of the holes in the diagonal push rods.
#define DELTA_DIAGONAL_ROD 218.0 // mm

// height from z=0 to home position
#define DELTA_HEIGHT 345.00 // get this value from auto calibrate
...
#define DELTA_TOWER_ANGLE_TRIM \
  {                            \
    0.0, 0.0, 0.0              \
  } // get these values from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT                                                        \
  {                                                                                        \
    DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 90 \
